...
"""`;
  ...
  $("#nv-export-pdf").addEventListener("click", async () => {
    ...
    try {
      ...
      // Use the real bounding box. Some browsers include extra whitespace in scrollWidth/offsetWidth,
      // which makes the PDF look left-shifted even though the content exists.
